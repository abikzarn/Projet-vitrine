    ...
    experience: [
        {
            ...
            description: [
                'Gestion du dimensionnement des équipes ≈140 Ingénieurs.',
                'Gestion financière du projet, validation des facturations et rédaction des rapports de facturation.',
                'Suivi des prévisions financières du projet : (coûts, revenus, marge).',
                'Contribution aux propositions commerciales et négociation des contrats.',
                'Rédaction des documents relatifs au projet (PRA, PAS, PAQ).',
                "Fourniture d’un support de qualité au client, animation des comités de pilotage."
            ],
            stack: [
        ...
        },
        {
            ...
            location: 'Velizy, France',
            description: [
                'Recueil des règles et exigences d’ingénierie à partir de la note de cadrage.',
                'Gestion des déploiements et alignement avec les règles d’ingénierie.',
                'Gestion des risques et suivi des plannings de déploiement (anticipation, plans d’action, alertes en cas de dérive).',
                'Gestion des risques et suivi des plannings de déploiement (anticipation, plans d’action, alertes en cas de dérive).',
                "Reporting et mise en place des indicateurs de performance (KPIs)."
            ],
            stack: [
                { name: 'Reactjs', icon: 'https://cdn.svgporn.com/logos/react.svg' },
                { name: 'Typescript', icon: 'https://cdn.svgporn.com/logos/typescript-icon.svg' },
